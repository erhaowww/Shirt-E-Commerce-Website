...
public class CartDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int totalQtyItem = Integer.parseInt(request.getParameter("totalQtyItem"));
...
//            Payment tempPaymentList = new Payment(payId);
            utx.begin();
            cartService.deleteItem(tempCarttList);
            if (totalQtyItem == 0) {
                paymentService.deleteItem(payId);
            }
            utx.commit();
