...
public class CustomerDisplay extends HttpServlet {
   ...
   @PersistenceContext
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException{
            ...
            List<PaymentDisplay2> cusList = payService.findByCustomer();
           ...
           session.setAttribute("payList", cusList);
   


           response.sendRedirect("all-customer.jsp");
