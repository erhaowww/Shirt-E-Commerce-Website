...
public class UserShipPack extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            List<PaymentDisplay2> availableList = payService.findByAvailable(user.getUserId());

            session.setAttribute("aList", availableList);
